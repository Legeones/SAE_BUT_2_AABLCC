 ...
 * @throws Exception
 */
function recup_event($dbh){ //fonction qui permet de récupérer une liste d'évènements en fonction de leur id et catégorie
    $i = $_SESSION['nbevent'];
    $k= 0;
...
//permet de supprimer les doublons qui se toruve dans la BDD
