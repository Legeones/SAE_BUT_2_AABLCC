    ...
    <form action="../../Controleur/Verifiant/Verification_Login.php" method="POST">
            ...
            <div class="Groupe">
                <div class="eyes">
                    ...
                    <div class="GroupeLOGO">
                        ...
                        <!-- class permettant l'apparition ou non du mot de passe -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="piedDePage">
            ...
            <div class="mdpOublie">
                ...
                <!-- Permets d'accéder à la page mot de passe oubliée -->
            </div>
        </div>
        ...
        <div class="CssUnified">
            ...
            <div class="piedDePage2">
                <div class="gauche">
                    <a href="../Accueil/charte_utilisation.php"><strong>Charte d'utilisation</strong></a>
                    <!-- Permets d'accéder à la page charte d'utilisation -->
                </div>
                <div class="droite">
                    <input type="button" onclick="window.location.href ='../Accueil/Aide.php';" value="?"/>
                    <!-- Permets d'accéder à la page aide -->
                </div>
            </div>
        </div>
    </form>
