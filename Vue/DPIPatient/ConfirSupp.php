...
<button onclick="location.href='../../Controleur/DPIPatient/SupprimerPatientSQL.php'">OUI</button>
<!-- Bouton oui supprimer patient -->
<button onclick="location.href='../../Vue/DPIPatient/SupprimerPatient.php'">NON</button>
