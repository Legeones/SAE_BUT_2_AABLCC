...
<div class="global">
    ...
    <div class="droite">
        <div class="div-norm-scenario">
            <?php
            if ($_SESSION["Role"] == "admin" or $_SESSION["Role"] == "prof") {echo "<button class='btn-norm' onclick=location.href='choixScenario.php'>Lancer scenario</button>"; echo "<button class='btn-norm' onclick= location.href='../Model/Scenario.php'>Création du scénario</button>";}
            ?>
        </div>
