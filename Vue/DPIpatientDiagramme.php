...
<div class="global">
    ...
    <div class="droite">
        <script type="text/javascript" src="../Controleur/scriptsDPIpatient.js"></script>
        <!-- zone d'ajout de boutons  -->
        <form action="../Controleur/actionDPI.php" name="cat" method="get" class="btn-line">
            <!-- zone d'ajout de boutons -->
        ...
        <form class="table-container" method="post" action="../Controleur/AjouterDPI.php">
            <table>
