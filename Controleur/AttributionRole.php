...
<head>
    ...
    <link rel="stylesheet" href="../Vue/CSS_DPI.css" media="screen" type="text/css" />
</head>
<body>
<header id="haut">
...
<div class="global">
    <div id="gauche" class="gauche">
        ...
        <div class="btn-group">
            <button onclick="location.href='../Vue/DPI.php'">PATIENTS</button>
            <button onclick="location.href='../Vue/principaleEve.php'">SCENARIOS</button>
        </div>
    </div>
