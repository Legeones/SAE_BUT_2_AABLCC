...
{ header('Location: ../DPIpatient/SupprimerPatient.php?erreur=1'); } // Zone de gestion des erreurs

elseif ($VerifPassword_Uppercase==1 || $VerifPassword_Lowercase==1)
{ header('Location: ../DPIpatient/SupprimerPatient.php?erreur=3'); } // Zone de gestion des erreurs
