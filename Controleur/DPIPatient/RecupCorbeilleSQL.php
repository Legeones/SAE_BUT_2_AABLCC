...
{ header('Location: ../../Vue/DPIPatient/RecupCorbeille.php?erreur=1'); } // Zone de vérification

elseif ($VerifPassword_Uppercase==1 || $VerifPassword_Lowercase==1)
{ header('Location: ../../Vue/DPIPatient/RecupCorbeille.php?erreur=3'); } // Zone de vérification
